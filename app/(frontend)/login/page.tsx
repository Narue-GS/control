  ...
  return(
    <>
      ...
      <section className="w-screen h-screen backdrop-brightness-75 md:backdrop-brightness-100 flex justify-center">
        <div className="bg-white h-fit w-[90vw] md:w-[25vw] min-w-[300px] rounded-lg outline p-4 mt-10 flex flex-col justify-between gap-2">
          <div className="flex flex-col gap-4">
            ...
            <button className="bg-pink-600 rounded-lg p-2 mt-2 text-white font-bold hover:bg-pink-500 transition">
