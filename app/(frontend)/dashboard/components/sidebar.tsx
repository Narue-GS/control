  ...
  return(
    <section className="min-w-[20rem] w-[25vw] min-h-screen border-r p-6 flex flex-col gap-12">
      ...
      <div className="flex flex-col gap-3">
        <Link href={"/dashboard"} className={`font-bold ${pathname == "/dashboard" ? "bg-pink-800 shadow-lg" : "hover:bg-pink-500 bg-pink-600"}  h w-[80%] text-white p-2 rounded-lg transition`}>Home</Link>
        {modules?.map((i) => (
